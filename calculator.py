...
def calculate():
    ...
    if equation != "":
        try:
            ...
            equation = result  # Update equation with result for further calculations
        except:
            result = "Error"
            equation = ""
        Label_result.config(text=result)

Label_result = Label(root, width=25, height=2, text="", font=("arial", 30), bg="#17161b", fg="#FFFFFF")
Label_result.pack()

Button(root, text="C", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#FFFFFF", bg="#3697f5", command=clear).place(x=10, y=100)
...
Button(root, text="=", width=5, height=3, font=("arial", 30, "bold"), bd=1, fg="#FFFFFF", bg="#fe9037", command=calculate).place(x=430, y=400)
